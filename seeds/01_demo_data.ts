...
export async function seed(knex: Knex): Promise<void> {
  ...
  await knex('users').insert([
    ...
    { id: 4, email: 'employee.ivanov@cook.local', role: 'employee', company_id: 1, password_hash: defaultPasswordHash, email_verified_at: verifiedAt, full_name: 'Иван Иванов', phone: '+79990000004', avatar_url: null, order_limit_cents: 100, debt_cents: 0, created_at: now, updated_at: now, deleted_at: null },
