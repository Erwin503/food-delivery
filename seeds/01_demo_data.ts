  ...
  await knex('companies').insert([
    {
      id: 1,
      name: 'ООО Ромашка',
      description: 'Офисный клиент с регулярными заказами обедов.',
    ...
    },
    {
      id: 2,
      name: 'АО Вектор',
      description: 'Технологическая компания с утренними доставками.',
    ...
    },
    {
      id: 3,
      name: 'ИП Север',
      description: 'Небольшая команда, заказывающая обеды по будням.',
      address: 'Москва, Новослободская, 18',
      debt_cents: 58800,
